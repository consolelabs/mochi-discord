...
import { handleSalesRemove } from "../sales/remove"
...
const command: SlashCommand = {
  ...
  prepare: () => {
    return new SlashCommandSubcommandBuilder()
      ...
      .addStringOption((option) =>
        option
          .setName("address")
          .setDescription("NFT address. Example: 0x7aCeE5D0acC520faB33b3Ea25D4FEEF1FfebDE73")
          .setRequired(false)
      )
  },
  run: async function (interaction: CommandInteraction) {
    ...
    return await handleSalesRemove(interaction,interaction.guildId, address??"",interaction.user.id)
  },
