...
//   let msg: Message = mockdc.cloneMessage()
...
//     [
//       {
//         name: "tip user successfully",
//         content: "$tip <@521591222826041344> 1.5 cake",
//         tipPayload: {
//           sender: userId,
...
//       { amountArg: "ftm", cryptocurrency: "MESSAGE", each: false }, // expected failure
//     ],
//   ])("processor.handleTip(%o)", (name, input, output) => {
//     expect(processor.parseTipParameters(input)).toStrictEqual(output)
//   })
// })
...
//     assertAuthor(output as RunResult<MessageOptions>, expected)
//     assertDescription(output as RunResult<MessageOptions>, expected)
//   })
...
//     assertThumbnail(output as RunResult<MessageOptions>, expected)
//     assertAuthor(output as RunResult<MessageOptions>, expected)
//     assertDescription(output as RunResult<MessageOptions>, expected)
//   })
